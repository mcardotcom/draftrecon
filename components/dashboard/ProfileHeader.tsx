...
export default function ProfileHeader() {
  const isPublic = true // Placeholder for status
  return (
    <Card className="flex items-center gap-6 bg-slate-800/70 backdrop-blur-md border border-slate-700 shadow-lg p-6 relative">
      ...
      <div className="flex-1 min-w-0">
        <h1 className="text-2xl font-semibold text-white">Builder Name</h1>
        <p className="text-indigo-400 text-sm">Automation Builder & Workflow Specialist</p>
