    ...
    <section className="w-full bg-[#1E293B] py-24 flex items-center justify-center">
      <div className="max-w-3xl mx-auto text-center px-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <button onClick={() => router.push('/cards')} className="px-8 py-3 rounded-2xl bg-signal-indigo hover:bg-signal-indigo/90 text-white font-semibold shadow-lg text-lg">Scout Talent</button>
        </div>
      </div>
    </section>
  )
